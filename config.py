...
BOT_TOKEN = os.environ.get("p6517235191:AAF0A550ymSnlbPyNJvf7otys0v6mwuluWk")
...
AUTH_USERS = list(int(i) for i in os.environ.get("AUTH_USERS", "2048030675").split(" ")) if os.environ.get("AUTH_USERS") else []
